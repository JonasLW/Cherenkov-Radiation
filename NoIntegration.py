...
w = 10**(-20)#6.59#(0,f.MaxW(n,m,v))#f.MaxW(n,m,v)#(0,f.MaxW(n,m,v))           # Photon frequency (eV)
...
r1 = f.RateTot(n,m,v,w,chi,phi,a)
r2 = f.PlusMinDiff(n,m,v,w,chi,phi,a)
#z1 = f.AmpOneMinSq( n, m, v, w, chi, phi, a )
#z2 = f.AmpOnePlusSq( n, m, v, w, chi, phi, a )
#z3 = f.AmpTwoMinSq( n, m, v, w, chi, phi, a )
#z4 = f.AmpTwoPlusSq( n, m, v, w, chi, phi, a )
